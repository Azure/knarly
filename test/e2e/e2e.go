...
var (
	...
	// getLogs collects cluster logs and resource data after tests
	getLogs bool
...
func init() {
	...
	flag.BoolVar(&getLogs, "e2e.get-logs", false, "if true, we'll collect log and resource data from the cluster after running E2E")
